...
$etudiant = $etudiantObj->obtenirEtudiantParMatricule($matricule);
...
<body>
    <div class="container">
        ...
        <a href="?matricule=<?= $etudiant['matricule']; ?>&action=download_pdf" class="pdf-link">Télécharger la carte</a>
